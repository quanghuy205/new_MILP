...
#initializing position and vector values with random values within a specific range
    ...
    while iteration_no < number_of_iterations:
        ...
        print("Iteration " + str(iteration_no+1) + " :\t" + " Path length: " + str(gb_fitness) + "\t")
        iteration_no = iteration_no + 1
        total_length=gb_fitness

    print('\n=====Completed', iteration_no, 'iterations=====')
    print("Total length of vehicle paths:",total_length)
    print("")
