...
capacity_of_vehicle, total_customers, distance_matrix, demand_matrix, X, Y = readdata(fileName)
...
#print("Vehicle Paths: ", Cluster_Customers)

trucks = RegExService.getData(fileName)
y=0
for path in Cluster_Customers:
    if y<trucks:
        print('Path', y+1, ':', path)
        y+=1
...
# # turtle screen
# screen = Screen()
# screen.title("PSO Visualization")
# print(Cluster_Customers)
# # function to visualize the best ant path
# Visualization.show_path(Cluster_Customers, trucks,fileName)
# screen.exitonclick()

# Plotting tours for SRC solutions
